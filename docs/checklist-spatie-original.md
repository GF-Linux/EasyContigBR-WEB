<!-- ARQUIVO DE TERCEIRO, guardado como referência. Não é o checklist deste
     projeto — o nosso é `docs/checklist-de-producao.md`, derivado deste.

     Origem: https://github.com/spatie/checklist-going-live (MIT), da Spatie,
     agência belga de desenvolvimento web. Escrito para sites Laravel indo ao
     ar. Trazido pelo autor em 2026-08-06.

     Metade dele não se aplica aqui: assume site PÚBLICO que QUER ser indexado,
     com newsletter e Google Maps, enquanto isto é um instrumento fechado por
     login com `.ab1` não publicado dentro. O que sobra dele, mais o que ele não
     cobre, está no nosso. Movido da raiz para cá em 07/08 porque, chamado
     `Readme - checklist.md`, parecia o README do projeto. -->
