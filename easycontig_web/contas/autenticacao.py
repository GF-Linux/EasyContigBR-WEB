#? AUTENTICAÇÃO — Decisão sobre quem entra 06/08/2026
#!
#! 1. Quem é o usuário, e se ele pode entrar. Dois provedores atrás da mesma
#!    requisição.
#! 2. `dev` — digita o e-mail e entra. SÓ para desenvolvimento local.
#! 3. `google` — OAuth do Google, como pedido na reunião com o Felipe. Gov.br e
#!    SIGAA foram descartados.
#! 4. `EASYCONTIG_DOMINIO=ufrrj.br` restringe a entrada ao domínio da UFRRJ.
#! 5. A divisão é essa: o Google prova QUEM É, o domínio decide QUEM ENTRA.
#! 6. ⚠️ A tela de consentimento do Google em "Testando" NÃO restringe ninguém
#!    (medido em 06/08). Quem barra é o domínio.
